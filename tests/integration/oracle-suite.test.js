...
if (!['oracle11', 'oracle12'].includes(process.env.SEQ_TEST_ADAPTER)) {
  throw new Error('SEQ_TEST_ADAPTER must be "oracle11" or "oracle12" for the Oracle integration suite.');
}
