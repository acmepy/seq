...
- No simules MySQL, Oracle u otra base de datos dentro de una prueba que se ejecuta únicamente con SQLite cuando el comportamiento pueda verificarse contra la base real.
